...
\begin{enumerate}
    \item \textbf{Route Selection}: The number of possible routes is $O(n!)$ when considering all permutations of port subsets. This is NP-hard, as established by the reduction from Prize-Collecting TSP \cite{reduccion2025}.
...
The reduction analysis \cite{reduccion2025} establishes that the Dutch Merchant Problem is NP-hard via reduction from Prize-Collecting TSP. This connection provides a natural framework for route generation:
